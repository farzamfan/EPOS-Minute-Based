 ...
 */
public class ModifiableIeposAgent<V extends DataType<V>> extends DynamicIncentiveIEPOSAgent<V> {
...
//		}
	...
	*/
	...
	@Override
	void updateCostSignalatRoot(DownMessage parentMg) {
	}
	...
	*/
	...
	public class ModifiableDownMessage extends DynamicIncentiveIEPOSAgent.DownMessage {
